...
const Header = () => {
    return (
        <div className='relative flex flex-col md:flex-row items-center bg-gradient-to-r from-primary to-blue-600 rounded-[2.5rem] px-8 md:px-16 lg:px-20 py-12 md:py-16 overflow-hidden shadow-xl animate-fade-in-up'>
            ...
            <div className='md:w-1/2 flex flex-col items-start justify-center gap-6 py-8 relative z-10'>
                ...
                <div className='flex flex-col md:flex-row items-start md:items-center gap-4 text-white/90 text-base font-medium'>
                ...
                <a
                    href='#speciality'
                    className='flex items-center gap-3 bg-white px-8 py-4 rounded-full text-gray-900 font-bold text-base hover:bg-blue-50 hover:shadow-2xl hover:scale-105 transition-all duration-300 shadow-lg group'
                >
                    Book appointment
