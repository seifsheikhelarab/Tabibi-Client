...
const Banner = () => {
    ...
    return (
        <div className='relative flex bg-primary rounded-[3rem] px-6 sm:px-10 md:px-14 lg:px-12 my-20 md:mx-10 overflow-hidden shadow-2xl'>

            {/* Background Decorations */}
            <div className='absolute top-0 left-0 w-80 h-80 bg-white/5 rounded-full blur-[80px] -ml-40 -mt-40'></div>
            ...
            <div className='flex-1 py-8 sm:py-10 md:py-16 lg:py-24 lg:pl-5 relative z-10'>
                ...
                <button
                    ...
                    className='bg-white text-sm sm:text-base text-gray-800 font-semibold px-10 py-4 rounded-full mt-8 hover:bg-gray-50 hover:shadow-xl hover:scale-[1.02] transition-all duration-300 shadow-lg'
                >
                    Create account
                </button>
            </div>
